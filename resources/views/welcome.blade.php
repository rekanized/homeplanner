<x-app-layout>
    <div style="max-width: 1280px; margin: 0 auto; padding: 40px 24px;">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 32px;">
            <div>
                <h1 style="font-size: 1.875rem; font-weight: 700; font-family: var(--font-heading); color: var(--text-main);">{{ __('Home Economy') }}</h1>
                <p style="color: var(--text-muted);">{{ __('Manage your household finances and shopping lists.') }}</p>
            </div>
            <div style="padding: 8px 16px; background: var(--primary-soft); color: var(--primary); border-radius: 9999px; font-size: 0.875rem; font-weight: 700; font-family: var(--font-outfit);">
                {{ now()->translatedFormat('F') }} – {{ now()->addMonths(2)->translatedFormat('F Y') }}
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 24px;">
            ...
            <a href="#" class="card" style="display: block; text-decoration: none; padding: 24px; transition: transform 0.2s, box-shadow 0.2s;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='var(--shadow-md)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='var(--shadow-sm)'">
                ...
                <h3 style="font-size: 1.125rem; font-weight: 700; color: var(--text-main); margin-bottom: 8px;">{{ __('Shopping List') }}</h3>
                <p style="font-size: 0.875rem; color: var(--text-muted);">{{ __('Organize your weekly groceries and household needs.') }}</p>
            </a>
            ...
            <a href="{{ route('economy.index') }}" wire:navigate class="card" style="display: block; text-decoration: none; padding: 24px; transition: transform 0.2s, box-shadow 0.2s;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='var(--shadow-md)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='var(--shadow-sm)'">
                ...
                <h3 style="font-size: 1.125rem; font-weight: 700; color: var(--text-main); margin-bottom: 8px;">{{ __('Budgeting') }}</h3>
                <p style="font-size: 0.875rem; color: var(--text-muted);">{{ __('Track income and expenses with ease.') }}</p>
            </a>
            ...
            <a href="#" class="card" style="display: block; text-decoration: none; padding: 24px; transition: transform 0.2s, box-shadow 0.2s;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='var(--shadow-md)'" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='var(--shadow-sm)'">
                ...
                <h3 style="font-size: 1.125rem; font-weight: 700; color: var(--text-main); margin-bottom: 8px;">{{ __('Kids Rewards') }}</h3>
                <p style="font-size: 0.875rem; color: var(--text-muted);">{{ __('Managed points and rewards for the little ones.') }}</p>
            </a>
        </div>
        </div>
    </div>

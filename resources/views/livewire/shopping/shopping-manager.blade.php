<div class="animate-in" x-data="{ editingListId: null }"
    ...
    <div class="card" style="border-radius: 28px; overflow: hidden;">
        ...
        @if($this->items->where('is_checked', true)->isNotEmpty())
            <div style="padding: 16px 20px 20px; border-top: 1px solid var(--border-color); display: flex; justify-content: center;">
                <button
                    wire:click="clearCheckedItems"
                    wire:confirm="{{ __('Remove all checked items from this list?') }}"
                    class="btn"
                    style="background: var(--danger-soft); color: var(--danger); border: 1px solid color-mix(in srgb, var(--danger) 18%, transparent); display: flex; align-items: center; gap: 8px; font-weight: 800;"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/></svg>
                    {{ __('Remove checked items') }}
                </button>
            </div>
        @endif
    </div>

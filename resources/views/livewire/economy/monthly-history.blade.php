<div>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: var(--space-6); margin-bottom: var(--space-8);">
        ...
        <button wire:click="triggerManualSnapshot" wire:confirm="{{ __('Capture a snapshot now? One-time expenses will be removed after they are safely included in the snapshot.') }}" class="btn-primary" style="padding: 12px 24px; border-radius: 12px; background: var(--primary); color: white; border: none; font-weight: 800; cursor: pointer; display: flex; align-items: center; gap: 8px;">

...
- **Frontend Stack:** Livewire 4 (strictly class-based), Alpine.js, Blade templates.
...
4. **Admin Features**: User management, authentication/module settings, audit logs, and release history.
